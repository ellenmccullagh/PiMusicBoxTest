...
if __name__ == '__main__':
    ...
    BUTTON_PINS = [
                    ...
                    Button(6, 24, 'White', 'Stories', 'spotify:playlist:0C7SxyofEe3bAWqxmyhruA' )#'spotify:playlist:7yYG0ULqH3D2NXiCG3HBOE') #playtime for miles: spotify:playlist:3pByZu2SyYiNlIppLXbUZ7 old stories playlist: spotify:playlist:0IJH6tPwq2lns377i4YvMd
                    ]
